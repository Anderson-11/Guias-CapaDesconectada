...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
            ...
            this._commandCollection[2].CommandText = "SELECT        CustomerID, CompanyName, ContactName, ContactTitle, Address, City, " +
                "Region, PostalCode, Country, Phone, Fax\r\nFROM            Customers\r\nWHERE       " +
        ...
        public virtual Northwind.CustomersDataTable GetDataBy(string CustomerID) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((CustomerID == null)) {
                throw new global::System.ArgumentNullException("CustomerID");
            }
        ...
        public virtual int Actualizar(string CustomerID, string CompanyName, string ContactName, string ContactTitle, string Address, string City, string Region, string PostalCode, string Country, string Phone, string Fax, string Original_CustomerID) {
